...
function SaveSongsBild(data) {
	...
	const autorPage_Div_Music_Content_Music_Play_Img =
		document.querySelectorAll(".autorPage_Div_Music_Content_Music_Play_Img")
...
<div class='mainPage_Autor_Img_Order_Div' id='autor_${autor.autor}' ></div>
<img class="mainPage_Autor_Card_Img" src="${img}" alt="">
...
function featch_autorPage_Create_MusicPlayer(data) {
    ...
    <div class='autorPage_Div_Music_Li'>
        ...
        <button class='autorPage_Div_Music_Content_Music_Play_Button'>
        <img class='autorPage_Div_Music_Content_Music_Play_Img ' 
								id="${arr.idpath}" src='../img/2ff977b7-2c90-41d5-813f-49170d570561.png' alt="" />
        </button>
        <button class='autorPage_Div_Music_Play_Button_Img_Songs'         >
        <img class='autorPage_Div_Music_Play_Img_Songs' src='${arr.img_autor}' alt="" />
        </button>
        ...
        <p class='autorPage_Div_Music_Play_Like_Num'>${arr.like}</p>
        <button class='autorPage_Div_Music_Play_Like_Button'>
        <img class='autorPage_Div_Music_Play_Like' id="${arr._id} "
								 src='${like_Img}' alt="" />
        </button>
        </div> 
     <button class='saveSongsButton' id='${arr._id}'>
...
function featch_autorPage_Create_Autor(info) {
    ...
    <img id='autorPage_Head_Autor_Content_Img_Left' 
				class='autorPage_Head_Autor_Content_Img_Left autorPage_Head_Autor_Content_Img_SwitcheCase' src="${autors.img_autor_rigth}" alt="">
...
function remove_switch_panel_players_music() {
	...
	img_Icon_Autorh_InPlayers.classList.remove("img_Icon_Autorh_InPlayers_Open")
